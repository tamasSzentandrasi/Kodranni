...
Product UX: [`visual-lock.md`](./visual-lock.md). Archive = read-only twin. ST desk = clone of the remade hall, last. Harm apply: result card and desk. Chat cards are later; research the host before CSS-on-embeds.
