...
Guidebook architecture (Astro + Starlight). Rules truth is the chapter files under `src/content/docs/`.

**Status (2026-08-18, evening):** Harden-and-raise packages 0–8 shipped. Verdict: §Verdict (pinnacle not reached).
...
Book-facing summary of the look as shipped. Do **not** restart oculus / title-in-cast / sidebar roundels / pagination-as-glass-tile.
