...
- **Ornament (soot/smoke + terminals):** One plate language — tooled highlight, lamp-soot, smoke drop, banner-diamond corner terminals (blood on identity, pewter on interactive). Very faint type texture: vine on identity, lozenge on widgets/Tide, laid paper on notes/quotes, lattice on counsel. No L-ticks, no red centred title bar. Chapter opening is a recessed stamp + Bellefair word + a short iron fade under the *word*. Role is colour. No new Markdown class, no raster banners, no drop-caps, no page frames, no fleur-de-lis/gold/leather. H2 stays a hairline.
