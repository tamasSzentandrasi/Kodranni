...
- **+2 Foundation points** (must be split across two different Foundations)  
  Cost: remove 5 skill points of your choice **or** accept one Negative Trait (Storyteller chooses).

- **+5 skill points**  
  Cost: –1 from a named Foundation of your choice.

- **One Positive named Trait**  
  Cost: remove 3 skill points of your choice.
