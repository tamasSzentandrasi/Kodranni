...
Each player may offer one claim about the person standing there:
...
| Purchase | Cost |
|----------|------|
| **+1** to a named Foundation | Remove **3** skill points of your choice |
| **+2** Foundation points (must split across two different Foundations) | Remove **5** skill points **or** accept one Negative Trait (Storyteller chooses) |
| **+5** skill points | **–1** from a named Foundation of your choice |
| **One Positive named Trait** | Remove **3** skill points of your choice |
