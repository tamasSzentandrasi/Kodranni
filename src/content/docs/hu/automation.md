...
A lapok és a tracker **közösségenként** élnek. A hosztolás és a megosztás moduláris: a közösség adata a tekintély; a chatfelületek csak utasításokat hajtanak rá.
...
**Nem** a fő Community trackeren (üléseszközök, nem álló közösségi állapot):

- **Tide** — akkor nyílik, ha kell; ha egy Tide véget ér, ami marad, általában audit/történet arról, hol állt le — nem állandó tracker-mező.
...
| Platform | Szerep |
|----------|--------|
| **Fluxer** | Chatfelület guild/szerver-kötéssel, tokenbeállítással, fiókleképezéssel |
| **Discord** | Ugyanaz a tartományviselkedés; guild ID-k, tokenbeállítás, fiókleképezés |

Minden telepítés platform-hitelesítőadatot, **guild / server ID**-t (vagy Fluxer-megfelelőt) és a **közösség** feljegyzését köti. A botok **fiók-ID-kat és nickeket** is karakterekhez képeznek, hogy a célzott utasítás mindig tudja, *melyik játékos karakterét* szólítja.

A botok vékony kliensek a közösségi tároló fölött. A csupasz perjel-bot nem elég: a játékos felőli UI-n a **Foundation**, **Skill**, fok, **Exertion**, **Echo**/**Myth** jelölés és a jóváhagyások **könnyen választhatók** legyenek, a platform beépített erősségeit használva először (menük, gombok a mesélői **Approve**/**Deny**-hoz, válaszszálak) — kutatott, újító, jó UX, nem zászlófal.

Ülések között és alatt a játékosok **szép közös nézetet** is használnak a lapokról és a Community trackerről: **élő** URL, amíg a mesélő ülése fut, és **nyilvános archívum** URL (kampánybemutató oldal), ha nem. A platform fiókleképezései és a teljes auditnyom a mesélő gépén maradnak — nem a nyilvános oldalon.

----------

## Tervezési elvek

1. **Mesélői hatalom** — Tartós változáshoz mesélői jóváhagyás kell, ahol a szabályok ezt mondják (Hierarchy, Inventory és hasonlók). A jóváhagyás **mesélői szerepű gombokkal** megy (**Approve** / **Deny**) a kérésüzeneten.  
2. **Először a fikció, aztán az utasítás** — A narrációban a mesélő megnevezi a **Foundation**t és a **Skill**t (vagy egyedül a Foundationt **Primitive**-nél). A **játékos** indítja a dobásutasítást a megállapodott konfiggal. Az automatizálás már tudja a leképezett fiókot és a karakterét; a UI-n ott az **Exertion**, a választható **Echoes** és a jelölhető közösségi **Myths**.  
...
4. **Következtess, ha biztonságos; mező, ha narratíva** — Olyan állapotok, mint a **Decadence** (hanyatlás) vagy a teherbírás-túllépés, az interakciókban kikövetkeztethetők, hogy kevesebb legyen a könyvelés. Az **Armour** és a **Reputation** továbbra is külön mezőt kíván: a jelenlétük a fikcióban dől el, mielőtt bármely arány menne. A Hierarchy **szintjei** teljes létrák, nem csak **Outsider**/**Ruler**; a relatív szintekülönbség narratívan rögzül, aztán az utasításban érvényesül.  
...
7. **Külön felépülés** — Az **Exertion** visszavétele és a **Harm** gyógyulása külön frissítés a narratív pihenő után.  
...
|----------|---------|--------|---------------|
| **Player roll** | Megállapodott konfiggal indítja; **Exertion** / **Echo** / **Myth** jelölés a UI-n | A fikcióban megnevezi a Foundation + Skill (vagy Primitive) párt és a fokot | Leképezi a fiókot → karakterre; a készletet a lapból tölti; dob + Omen; frissíti a Practice/Exertiont |
| **Storyteller NPC roll** | — | ST dobásmenetet használ: Foundation, Skill, Exertion, fok stb. (nincs PC-lap) | Dob és jelent; nincs PC-lap mutáció, hacsak nincs célpont |
...
| **Practice** | Látható a lapon | **Prompt degrade** (időugrás) | Gyűlik; szintez; promptolt degrade |
...
| **Echoes** | Létrehoz / felidéz / lezár a mesélővel | Hangnemet vétóz; a lezárás jutalmát adja | Súly a teherbírással szemben; a mesélő rendelte lapváltozásokat alkalmazza |
...
**Ellendobás:** bármely dobás (játékos vagy ST) **válaszként** egy dobásüzenetre. A pároknak nem kell illeniük.
...
- **Birth Omen** (születési ómen) és **Guiding Hand** (vezető kéz): az automatizálás dob; a pontok a piszkozatlapra esnek.  
- **Words** / **Wanting**: a beszélő egy **Word**et a **saját** lapján költ (menüopció). A mesélő jelöli az elfogadott állítás **célpontját**. A színház emberi marad; a számolás és a megőrzés nem.

----------

## Beállítás (alakuló)

A telepítési lépések, a Fluxer vs Discord tokenek, a fiókleképezés és a UI-kutatás a projekt forrásához tartoznak, és iterálódnak. Amíg a termék nem száll, ezt a fejezetet **viselkedési szerződésnek** vedd.
...
A mérnöki jegyzetek a projekt forrásában élnek, nem ezen a lapon.
