...
Ez a lap az asztalnak szóló szerződés. A mérnöki irány a projekt forrásában van, és változik, ahogy a termék UI-ja kialakul. A mesélő rekordmódosításai webes pultra mennek (a tracker és a lapok klónja). A Discord és a Fluxer tartja a dobásokat. A **Harm** az eredménylapon és azon a pulton is alkalmazható.
