...
<p data-person-note="default">Kattints egy névre. Minden tengelyen kigyullad, ahol ül. A Pénz megbízott foka itt üres.</p>
<p data-person-note="marino" hidden>Uralkodó. Nem tud lovagolni. Vito viszi a háztartást a nevében.</p>
<p data-person-note="vito" hidden>Megbízott, Fegyver — a háztartás. Elismert, Vér.</p>
<p data-person-note="jakov" hidden>Elismert, Fegyver. Szabad Társaság.</p>
<p data-person-note="orsa" hidden>Tisztelt, Vér. Caterina a megbízottja.</p>
<p data-person-note="caterina" hidden>Elismert, Hit. Elismert, Vér.</p>
<p data-person-note="piero" hidden>Tisztelt, Pénz. Raktárak az alsóvárosnak.</p>
<p data-person-note="lovro" hidden>Tisztelt, Hit. Székesegyház ajtaja. A test nála van.</p>
<p data-person-note="luca" hidden>Kívülálló. A tornácon. Belépéskor kitaszított a ráillő tengelyeken.</p>
</div>
...
<p class="kod-hier-ruler__note">Egy hely minden tengely fölött. Marino ül rajta.</p>
</div>
...
<li><strong>Megbízott</strong> <button type="button" class="member" data-person="vito" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Vito</span></button></li>
<li><strong>Elismert</strong> <button type="button" class="member" data-person="jakov" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Jakov</span></button></li>
...
<ol class="kod-hier-rungs">
<li><strong>Tisztelt</strong> <button type="button" class="member" data-person="lovro" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Lovro</span></button></li>
<li><strong>Megbízott</strong></li>
<li><strong>Elismert</strong> <button type="button" class="member" data-person="caterina" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Caterina</span></button></li>
<li><strong>Kitaszított</strong></li>
</ol>
</div>
...
<ol class="kod-hier-rungs">
<li><strong>Tisztelt</strong> <button type="button" class="member" data-person="piero" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Piero</span></button></li>
<li><strong>Megbízott</strong></li>
...
<ol class="kod-hier-rungs">
<li><strong>Tisztelt</strong> <button type="button" class="member" data-person="orsa" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Orsa</span></button></li>
<li><strong>Megbízott</strong></li>
<li><strong>Elismert</strong> <button type="button" class="member" data-person="vito" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Vito</span></button> <button type="button" class="member" data-person="caterina" data-play><span class="member__stain" aria-hidden="true"></span><span class="member__glow" aria-hidden="true"></span><span class="member__name">Caterina</span></button></li>
<li><strong>Kitaszított</strong></li>
</ol>
</div>
</div>
...
<p class="kod-example__scene">A fenti foglaltság ez a jelenet a lezárás után. Orsa Solari — tisztelt a Véren, Isotta nővére — Caterina Velát nevezte a székesegyházi káptalan előtt. Caterina tizenkét évig öltöztette Isottát. Vito emberei már másolták az utcát, ahol a gyerekei alszanak. Orsa megbízása: hozd a neveket mindenkitől, akinek kulcsa volt a belső lépcsőhöz az éjszakán, amikor Isottát megölték, és Orsa kiáll Vitóval szemben, amikor az emberei azért az utcáért jönnek. Ez a kötés visszhang lett. Caterina három nevet hozott. Orsa kiállt. A mesélő a Véren kitaszított → elismertet hagyott jóvá. A Hit maradt. A Fegyver nem mozdult. Ha Orsa később megszégyeníteni próbálja Caterinát a csarnokban, a Vér rése (tisztelt vs elismert) a társas sérülés védelmi aránya. Marino azon a létrán nincs: uralkodik, mert még ül, és mert Vito az ő nevében visz el embereket. Jakov a Fegyveren azért ül, mert a társaság még tartja a házát, nem mert Marino nevezte.</p>
