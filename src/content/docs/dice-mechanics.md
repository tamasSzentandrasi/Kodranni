...
description: When to roll — and how the rest of the stack is organised.
---

> *Wyrd oft nereð unfægne eorl, þonne his ellen dēah.*
> *“Fate often spares the hero not fated to die, when his courage holds.”*
> — *Beowulf*
...
The Storyteller always chooses which [Foundation](/foundations/) and (if any) [Skill](/skills/) fit the described intent, and which **die tier** the pool uses — that tier is the mechanical face of **[Advantage and Disadvantage](/marks-and-tiers/#advantage-and-disadvantage)**.

Related: [Marks & Tiers](/marks-and-tiers/), [Omens](/omens/), [Tide](/tide/).
