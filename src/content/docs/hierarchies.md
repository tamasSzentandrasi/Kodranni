...
Read the diagram top-down: one crown, then parallel ladders. Each column is a separate Hierarchy. Each ladder uses the **same four tiers** (top of column = Honoured, bottom = Outcast). **Setup** leaves every rung empty of names. **In play** is a worked occupancy — Aspalath after the night the knife missed — so dual-axis, patronage, delegation, contested Arms, and the outsider porch can be seen at once.
...
<p class="kod-example__scene">The occupancy above is this scene after it resolved. Orsa Solari — Honoured on Blood, Isotta’s sister — named Caterina Vela before the cathedral chapter. Caterina dressed Isotta for twelve years. Vito’s men have already copied the street where her children sleep. Orsa’s charge: bring the names of everyone who had a key to the inner stair the night Isotta was killed, and Orsa will stand in front of Vito when his men come for that street. That binding became an Echo. Caterina brought three names. Orsa did stand. The Storyteller approved Blood Outcast → Acknowledged. Faith stayed. Arms did not move. If Orsa later tries to shame Caterina in the hall, the Blood gap (Honoured vs Acknowledged) is the protection ratio for social Harm. Marino is not on that ladder: he rules because he still sits, and because Vito takes people in his name. Jakov is on Arms because the company still holds its house, not because Marino named him.</p>
<ol class="kod-example__steps">
<li><strong>Patronage / hook:</strong> Orsa (Honoured, Blood) publicly binds Caterina: names from the inner stair, in exchange for standing when Vito’s men come for her street.</li>
<li><strong>Echo created:</strong> “Bring Orsa the names from the inner stair” (weight set at the table).</li>
<li><strong>Advancement:</strong> Caterina brought three names; Orsa stood. Blood Outcast → Acknowledged. Faith and Arms stayed.</li>
<li><strong>Delegation:</strong> Marino (Ruler) does not sit Trusted Arms — Vito does, because the duke cannot ride. Jakov sits Acknowledged Arms from the company’s house, not from that delegation.</li>
<li><strong>Reputation / social combat:</strong> Orsa vs Caterina on Blood is a two-rung gap. That gap is the protection ratio when social or mental Harm is applied. Nothing else is mechanically attached to tier.</li>
</ol>
</aside>
