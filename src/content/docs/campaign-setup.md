...
A good seed names a **community**, a **real pressure** (war, law, plague, tax, famine, migration), and a **decision that cannot wait**. It is not a list of horrors. Grim reality is the weather of the age — not the product you are selling.
...
<p class="kod-seed__title">Anatolian hill villages after Manzikert (c. 1080s→)</p>
<p><strong>Basis:</strong> Byzantine collapse in central Anatolia after Manzikert. <strong>Break:</strong> your related hill villages were never fully absorbed into a stable beylik or restored theme. For a generation they have paid tax and forage to whichever armed band held the road that season. This year a Turkic lord means to settle permanent garrisons; a coastal Byzantine agent offers arms if the villages rise and hold the passes until “relief” that may never come. Grain is already short. Young men are leaving as hirelings.</p>
...
<div class="kod-seed kod-seed--semi">
<p class="kod-seed__title">Vinland held (c. 1020→)</p>
...
<p class="kod-seed__title">After the lost war</p>
<p>A free valley of related freeholders fought on the wrong side of a short war. The victors now hold the low road and the toll bridges. They demand arms surrendered, a fixed grain levy, and hostages from the leading houses — not extermination. Winter stores were spent in the campaign. The next levy is due before spring sowing. Some houses want to comply and plant. Others want to keep weapons and risk a second fight they cannot win alone.</p>
...
<div class="kod-seed kod-seed--invented">
<p class="kod-seed__title">Closed city, fifth month</p>
<p>A river town has been under siege since harvest. The garrison is foreign and unpaid. The citizen houses still control what remains of the granaries. Peace terms have been offered: open a gate, accept a new garrison, hand over named leaders for trial. A war party wants to hold until the ice breaks and river trade can move again. Disease is in the poorer quarters. Both parties need the consent of the same few houses that the players are tied to.</p>
