...
describe('renderArchivePage', () => {
  it('renders the hall from a snapshot with Fortunes, Find, and names', () => {
    ...
    expect(html).toContain('data-slide-toggle="find"');
    expect(html).toContain('data-slide="find"');
    expect(html).toContain('aria-label="Find"');
    expect(html).toContain('kod-slide__tab');
    expect(html).toContain('kod-slide__chev');
    expect(html).toContain('data-slide="factions"');
    expect(html).toContain('data-slide="tags"');
    expect(html).not.toContain('data-find-hide');
    expect(html).not.toContain('Find in the hall');
    expect(html).not.toContain('find-handle');
    expect(html).not.toContain('data-find-toggle');
    ...
    expect(html).toContain('kod-btn--folio');
    expect(html).toContain('data-catchword');
    expect(html).toContain('end-mark--left');
    expect(html).toContain('end-mark--right');
    expect(html).not.toContain('data-kind-filter');
